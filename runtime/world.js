...
var LambdaDriver = require('./lambdaDriver');
 ...
 */
function getDriverInstance(scenarioname) {
    ...
    switch (browserName || '') {
        ...
        case 'bs': {
            driver = new BSDriver(scenarioname);
        }
            break;
...
module.exports = function () {
    ...
    this.Before(function (scenario) {
        if (!global.driver) {
            global.driver = getDriverInstance(scenario.getName());
        }
